                    ...
                    >
                         <div className="relative">
                              <motion.button
                                   ...
                                   className={`neu-button px-6 py-3 rounded-xl font-medium text-gray-700 flex items-center gap-3 min-w-[200px] justify-between transition-all duration-300 ${isDropdownOpen ? 'border-2 border-cyan-400' : 'border-2 border-transparent'
                                        }`}
                              >
