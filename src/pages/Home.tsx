                              ...
                              <form onSubmit={handleSubmit} className="max-w-4xl mx-auto">
                                   ...
                                   >
                                        <motion.button
                                             ...
                                             className={`neu-button px-12 py-4 font-semibold text-gray-800 inline-flex items-center space-x-3 text-lg transition-all duration-300 relative group focus:outline-none ${isSubmitting ? 'opacity-70 cursor-not-allowed' : 'hover:shadow-lg'
                                                  }`}
                                             style={{
                                                  border: 'none'
                                             }}
