    ...
    <div className="space-y-8">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="text-center p-4 rounded-lg transition-all duration-300 bg-gradient-to-br from-green-50 to-green-100">
            <p className="text-2xl font-bold transition-colors duration-300 text-green-700">
              {totalCommits}
            </p>
            <p className="text-sm transition-colors duration-300 text-green-600">
          ...
          <div className="text-center p-4 rounded-lg transition-all duration-300 bg-gradient-to-br from-purple-50 to-purple-100">
            <p className="text-2xl font-bold transition-colors duration-300 text-purple-700">
              {((activeMonths / 12) * 100).toFixed(0)}%
            </p>
            <p className="text-sm transition-colors duration-300 text-purple-600">
              Consistência
            </p>
          </div>
        </div>
